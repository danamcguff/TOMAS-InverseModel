...
C     nflg - says if nucleation happend
      ...
      SUBROUTINE getNucRate(Gci,fn,rnuc,nflg,x,time,xmeas)
...
C-----ARGUMENT DECLARATIONS---------------------------------------------
      ...
      double precision time ! seconds
      integer Istar, error, xmeas
      double precision NUCtime(1920), NUCrate(1920)
...
c      print*,'getNucRate:', 'h2so4',h2so4,'nh3ppt',nh3ppt
